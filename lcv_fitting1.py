...
def phase_lcv(lcv_data, lcv_name, period, T0=0, plot=1, save=0, error_threshold=0.1, save_dir=''):
    ...
    if plot == 1:
        ...
        plot_file = save_dir+lcv_name+'-fit.pdf' #re.sub('\.ph', '-fit.pdf', phased_lcv_file)
